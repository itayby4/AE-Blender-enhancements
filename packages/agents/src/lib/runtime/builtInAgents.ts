...
export interface AgentProfile {
  name: string;
  type: TaskType;
  /** One-liner shown in the AgentTool description catalog. */
  whenToUse: string;
  /** Optional system-prompt override for workers spawned from this profile. */
  systemPrompt?: string;
  /** Optional allowlist of tool names the worker may call. */
  allowedTools?: string[];
}
