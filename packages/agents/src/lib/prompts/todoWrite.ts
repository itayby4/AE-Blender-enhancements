...
/**
 * TodoWrite — system-prompt teaching block.
 *
 * Structure mirrors OpenClaude's TodoWriteTool/prompt.ts (tool rules, state
 * machine, when-to-use, when-NOT-to-use, examples) but prose is written
 * fresh for PipeFX's video/audio editing domain. See ../../PROMPT_SOURCES.md.
 */
