  ...
  return (
    ...
    <div className="flex flex-col h-screen bg-background text-foreground font-sans overflow-hidden select-none relative">
      ...
      >
        ...
        {/* NLE app selector */}
        <Select value={activeApp} onValueChange={(val) => val && setActiveApp(val)}>
          <SelectTrigger className="w-[140px] h-7 bg-muted/40 border-border/40 rounded-full font-semibold px-3 text-xs shrink-0">
        ...
        {/* Connection dot */}
        <div
          className="flex h-5 w-5 items-center justify-center rounded-full bg-muted/40 shrink-0"
          ...
          <div className="flex-1 min-h-0 flex flex-col">
            ...
            {activeView === 'chat' && (
              <ChatPanel
                ...
                onSendMessage={chat.sendMessageToAi}
