  ...
  return (
    <div className={`relative w-72 ${isExpanded ? 'scale-[1.5] origin-center z-50' : ''}`}>
      ...
      <CardContent className="p-0 flex flex-col">
        ...
        <div className={`relative w-full bg-black flex items-center justify-center border-b border-border/50 overflow-hidden ${data.ratio === '9:16' ? 'aspect-[9/16]' : data.ratio === '1:1' ? 'aspect-square' : 'aspect-[16/9]'}`}>
           {data.error ? (
